  ...
  return (
    <section className={`relative overflow-hidden ${className}`}>
      <div className={`relative w-full ${height}`}>
        ...
        {/* Bottom fade */}
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[38%] bg-gradient-to-b from-transparent via-white/20 to-white/95" />

        {/* Content */}
        <div className="relative z-10 container">
          <div className="flex min-h-[420px] items-start pt-24 md:min-h-[500px] md:pt-28 lg:min-h-[615px] lg:pt-32">
            <div
