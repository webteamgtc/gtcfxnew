  ...
  return (
    <section className="relative overflow-hidden bg-primary-gradient">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        {/* Background video */}
        <div className="hidden md:block absolute inset-x-0 bottom-20 opacity-25 md:bottom-0">
          <div className="">
            <div className="relative overflow-hidden">
              <video
                ...
                preload="auto"
              >
                <source src="/home2/video-final.mp4" type="video/mp4" />
              </video>
            </div>
          </div>
        </div>
      ...
      <div className="container relative z-10">
        <div className="flex min-h-[87vh] flex-col items-center justify-center pt-28 pb-10 text-center md:pt-28 md:pb-0 lg:pt-32 lg:pb-0 sm:min-h-[125vh] 2xl:min-h-[100vh] 3xl:min-h-[90vh] 4xl:min-h-[95vh] 5xl:min-h-[90vh]">
          <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-gray-500 bg-[#ffffff5b] px-4 py-2 shadow-[0_6px_20px_rgba(0,0,0,0.08)]">
            ...
            <span className="text-[14px] font-medium text-white md:text-lg"> 
              {t("badge.title")}
            </span>
          </div>
          ...
          <div className="mt-10 w-full max-w-[1120px] md:mt-10 lg:mt-14 3xl:mt-24">
