...
export default function HeroSectionHomeVideo() {
  ...
  return (
    <section className="relative overflow-hidden bg-primary-gradient">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(182,135,86,0.09)_0%,rgba(35,47,116,0)_85%)]" />

        {/* Background video */}
        <div className="absolute inset-x-0 bottom-20 opacity-25 md:bottom-0">
          <div className="">
            <div className="relative overflow-hidden">
              <video
                ...
                preload="auto"
              >
                <source src="/home2/04.mp4" type="video/mp4" />
              </video>
            </div>
          </div>
        </div>
      ...
      <div className="container relative z-10">
        <div className="flex min-h-[87vh] flex-col items-center justify-center pt-28 pb-10 text-center md:pt-28 md:pb-0 lg:pt-32 lg:pb-0 2xl:min-h-[95vh] 3xl:min-h-[90vh] 4xl:min-h-[95vh] 5xl:min-h-[90vh]">
