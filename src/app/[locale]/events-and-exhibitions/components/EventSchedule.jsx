    ...
    <section id="event-schedule" className="w-full bg-[#0b153a]">
      ...
      <div className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-[220px] left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-[#2d3bb9]/30 blur-[90px]" />
          <div className="absolute bottom-[-260px] left-[-200px] h-[520px] w-[520px] rounded-full bg-[#0b153a] blur-[80px]" />
          <div className="absolute bottom-[-260px] right-[-200px] h-[520px] w-[520px] rounded-full bg-[#0b153a] blur-[80px]" />
        </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-10 md:py-16">
          ...
          <div className="md:mt-10 mt-5 flex justify-center">
            <div className="flex items-center gap-1 rounded-full bg-white/15">
              {availableYears.map((y) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "md:min-w-[100px] min-w-[80px] rounded-full md:px-5 px-4 py-2 md:text-[20px] text-[16px] font-normal transition",
                      isActive
                    ...
                    <div key={it.id}>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 md:hidden">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#0D1155] ring-1 ring-[#4B4B4B]">
                        ...
                        <div className="hidden items-center gap-3 md:flex">
                          <div className="flex h-[42px] w-[42px] shrink-0 items-center justify-center rounded-full bg-[#0D1155] ring-1 ring-[#4B4B4B] transition group-hover:bg-white/12">
                                  ...
                                  ? active?.longDescription
                                    ...
                                    ?.map((paragraph, i) => (
                                      <li key={i} className="relative pl-5 md:pl-6">
                                        <span className="absolute left-0 top-[5px] h-2 w-2 rounded-full bg-[#D48755] md:top-[6px] md:h-[12px] md:w-[12px]" />
                                        {paragraph?.trim()}
                                      </li>
                                    ))
                                  : ""}
