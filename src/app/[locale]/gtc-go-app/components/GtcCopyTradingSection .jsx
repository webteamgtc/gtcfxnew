    ...
    >
      <div className="container grid gap-12 lg:grid-cols-2 items-center">
        ...
        <div className="order-2 lg:order-1 text-center lg:text-left space-y-6 max-w-xl">
          ...
          <ul className="space-y-4 text-sm md:text-base text-slate-700">
            ...
            {[
              ...
              <li key={index} className="flex items-start gap-3">
                ...
                {/* Premium bullet */}
                <span className="mt-1 flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-r from-[#293794] to-[#000021] text-white text-xs">
                  ✓
                </span>
          ...
          <div className="pt-3">
            <button
              ...
              className="inline-flex items-center px-7 py-3 rounded-full bg-gradient-to-r from-[#293794] to-[#000021] text-white text-sm md:text-base font-semibold shadow-lg shadow-blue-200/40 hover:scale-[1.02] hover:opacity-90 transition"
            >
              Download App Now
            </button>
          </div>
        ...
        <div className="relative flex justify-center lg:justify-end order-1 lg:order-2">
          ...
          {/* Glow Background */}
          <div className="absolute right-0 top-10 h-[520px] w-[520px] rounded-full bg-gradient-to-br from-[#e8eefc] via-[#b8c6e0] to-[#9aa7c0] opacity-60 blur-[60px] hidden sm:block" />
