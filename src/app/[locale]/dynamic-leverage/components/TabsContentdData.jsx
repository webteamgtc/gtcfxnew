...
const TabsContentData = ({ locale = "en" }) => {
  ...
  const renderTableForActiveTab = () => {
    switch (activeTab) {
      case 'Forex':
        return <ForexTable locale={locale} category="Forex" />;
      case 'Metals':
        return <ForexTable locale={locale} category="Metals" />;
      case 'Energies':
        return <ForexTable locale={locale} category="Energies" />;
      case 'Cash Index':
        return <ForexTable locale={locale} category="Cash Index" />;
      case 'Future Index':
        return <ForexTable locale={locale} category="Future Index" />;
      case 'Crypto':
        return <ForexTable locale={locale} category="Crypto" />;
      default:
